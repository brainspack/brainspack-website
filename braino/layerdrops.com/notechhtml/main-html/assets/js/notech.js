...
$(document).ready(function () {
  ...
  $(".display-selecter svg rect").attr("stroke", "black");
  $(".display-selecter svg:first rect").attr("stroke", "#40a27c");

  $(".display-selecter svg").click(function () {
    $(".display-selecter svg rect").attr("stroke", "black");

    $(this).find("rect").attr("stroke", "#40a27c");
